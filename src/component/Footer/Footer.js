...
import img1 from '../../common/assets/images/payments/1.png'
import img2 from '../../common/assets/images/payments/2.png'
import img3 from '../../common/assets/images/payments/3.png'
import img4 from '../../common/assets/images/payments/4.png'
import img5 from '../../common/assets/images/payments/5.png'
          ...
          <div className="container">
            ...
            <div className="col-xs-12 col-sm-6 no-padding">
              <div className="clearfix payment-methods">
                <ul>
                  <li><img src={img1} alt="1" /></li>
                  <li><img src={img2} alt="2" /></li>
                  <li><img src={img3} alt="3" /></li>
                  <li><img src={img4} alt="4" /></li>
                  <li><img src={img5} alt="5" /></li>
                </ul>
              </div>
            </div>
          </div>
